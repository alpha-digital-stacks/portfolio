...
export function ModeToggle() {
  ...
  return (
    <button
      ...
      className="relative w-12 h-12 flex items-center justify-center rounded-full border border-white/20 cursor-pointer transition-all duration-300 hover:scale-105 hover:shadow-lg bg-primary shadow-[0_12px_30px_-12px_rgba(254,67,0,0.8)]"
    >
